...
@WebServlet(name = "jefeComiteMiembroCreado", urlPatterns = {"/jefeComiteMiembroCreado"})
public class jefeComiteMiembroCreado extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                out.println("Organizador registrado con éxito <a href='jefeComiteAdminMiembro?idJefeComite=" + idJefeComite + "' class='alert-link'>Volver</a>");
                out.println("</div>");
            } catch (SQLException ex) {
                out.println("<div class='alert alert-danger' role='alert'>");
                out.println("No se pudo registrar el Organizador <a href='jefeComiteAdminMiembro?idJefeComite=" + idJefeComite + "' class='alert-link'>Volver</a>");
                out.println("</div>");
