...
public class registrarServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<header align='center'><h1>Registro</h1></header><br/><br/>");
            ...
            out.println("<select class='form-select' id='grupoTipo' name='tipoUsuario'>");
            out.println("<option value='1'>Asistente</option>");
            out.println("<option value='2'>Autor</option>");
            out.println("<option value='3'>Revisor</option>");
            out.println("</select>");
            out.println("</div></div>");
            out.println("<div class='mb-3' align='center'>");
            out.println("<input type='submit' class='btn btn-success'>");
