...
@WebServlet(name = "miembroEventoModificado", urlPatterns = {"/miembroEventoModificado"})
public class miembroEventoModificado extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(miembroEventoModificado.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<title>Evento modificado</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            try {
                ...
                out.println("Evento modificado con éxito <a href='miembroComiteServlet?idMiembro=" + idMiembro + "' class='alert-link'>Volver</a>");
                out.println("</div>");
            } catch (SQLException ex) {
                out.println("<div class='alert alert-danger' role='alert'>");
                out.println("No se pudo modificar el evento <a href='miembroComiteServlet?idMiembro=" + idMiembro + "' class='alert-link'>Volver</a>");
                out.println("</div>");
                Logger.getLogger(miembroEventoModificado.class.getName()).log(Level.SEVERE, null, ex);
            }
